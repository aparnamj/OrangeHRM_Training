...
public class BaseClass {
	...
	static String Relativepath_failure = filePath + "\\Failure_ScreenShot";
	static String Relativepath_success = filePath + "\\Sucess_ScreenShot";
	
	public static String getScreenhotfailure(WebDriver driver, String screenshotName) throws Exception {
		String dateName = new SimpleDateFormat("yyyyMMddhhmmss").format(new Date());
		TakesScreenshot ts = (TakesScreenshot) driver;
		File source = ts.getScreenshotAs(OutputType.FILE);
                //after execution, you could see a folder "FailedTestsScreenshots" under src folder
		String destination = Relativepath_failure + "/Failure_ScreenShot/"+screenshotName+dateName+".png";
	...
	public static String getScreenhotSuccess(WebDriver driver, String screenshotName) throws Exception {
		...
		File source = ts.getScreenshotAs(OutputType.FILE);
                //after execution, you could see a folder "FailedTestsScreenshots" under src folder
		String destination = Relativepath_success + "/Success_ScreenShot/"+screenshotName+dateName+".png";
		File finalDestination = new File(destination);
		FileUtils.copyFile(source, finalDestination);
		return destination;
	}
	// Connection objectmy
			...
			// String[][] arrayDBData = null;
				...
				String query = "select uname,upass from loginweb";
